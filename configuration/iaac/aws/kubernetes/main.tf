...
# terraform-backend-state-sophia19053-123
...
module "in28minutes-cluster" {
  ...
  subnet_ids         = ["subnet-0cd1a6be15ddbebcc", "subnet-0434639604b02ba64", "subnet-02049994a7cbe48b7"] #CHANGE # Donot choose subnet from us-east-1e
